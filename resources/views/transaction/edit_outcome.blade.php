          ...
          <div class="card">
            <div class="card-body">
              <div class="e-profile">
                ...
                <!-- Form -->
                <form action="/transaction/edit_outcome/{{ $transaction->id }}" method="post">
                  @csrf
                            ...
                            <div class="col-12 col-sm-8 mb-3">
                              <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" id="category">
                                  ...
                                  <option value="{{ $category->id }}" {{ old("category_id", $transaction->category_id)==$category->id ? "selected" : "" }}>{{ $category->category_name }}</option>
                                  @endforeach
                                </select>
                                @error('category_id')
                            ...
                            <div class="col-12 col-sm-4 mb-3">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="outcome" name="outcome"
                                  placeholder="Nhập chi phí" value="{{ old('outcome', $transaction->outcome) }}">
                                @error('outcome')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                              </div>
                            ...
                            <div class="col mb-3">
                              <div class="form-group">
                                ...
                                <input class="form-control" id="description" name="description"
                                  placeholder="Nhập mô tả chi phí" value="{{ old('description', $transaction->description) }}">
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                              </div>
