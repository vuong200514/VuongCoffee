...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            "product_name" => "Trà sữa Thái Lan",
            "orientation" => "Trà sữa Thái Lan nổi tiếng với hương vị thơm ngon, kết hợp giữa trà xanh và các loại thảo mộc tự nhiên.",
            "description" => "Trà sữa Thái Lan được pha chế từ trà xanh cao cấp, kết hợp với sữa đặc và các loại thảo mộc tạo nên hương vị đậm đà, thơm ngọt đặc trưng. Đây là món thức uống được yêu thích bởi sự tươi mát và vị ngọt thanh dễ chịu.",
            "price" => 45000,
            "stock" => 150,
            "discount" => 10,
