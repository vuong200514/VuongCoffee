<!-- filepath: /d:/vscode/larevel/VuongCoffe/resources/views/order/make_order.blade.php -->
              ...
              <div class="col-md-4">
                ...
                {{ old('price', $product->price) }}" type="text" class="form-control" disabled>
                  ...
                  <input type="hidden" id="price" name="price"
                    ...
                    value="VND {{ old('price', ((100 - $product->discount)/100) *$product->price) }}" type="text"
                    class="form-control" disabled>
                  @endif
                  <div class="input-group" style="display:unset;">
                    <div class="input-group-prepend">
                      ...
                      @else
                      <span class="input-group-text">VND {{ ((100 - $product->discount)/100) * $product->price }} <span
          ...
          <div id="collapseCC" class="accordion-collapse collapse {{ old('payment_method')==1 ? 'show' : '' }}"
            ...
            <div class="accordion-body">
                ...
                <div id="mbbank" class="form-check w-100 collapsed">
                  <span><img src="{{ asset('storage/icons/bank-mb.png') }}" alt="MB logo" width="40px"></span>
